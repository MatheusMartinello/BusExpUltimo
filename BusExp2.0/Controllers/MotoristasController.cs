...
namespace BusExp2._0.Controllers
{
    public class MotoristasController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MotoristaId,Nome,Cpf")] Motorista motorista)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MotoristaId,Nome,Cpf")] Motorista motorista)
        {
            if (ModelState.IsValid)
            {
